...
if __name__ == '__main__':
    ...
    parser.add_argument('--split', help='split to evaluate on', default='validate_hin')
    ...
    dataset[args.split].record_preds(
        preds=preds,
        to_file=os.path.join('exp/glad/default', args.split+'.json'),
    )
